...
//  DTO COM VALIDAÇÃO COMPLETA — PRIMEIRA LINHA DE DEFESA
...
public class VehicleDTO {
    ...
    //  VALIDAÇÃO DE PLACA — TIPAGEM + PRESENÇA + TAMANHO + FORMATO
    @NotBlank(message = "Placa é obrigatória")
    @Size(min = 7, max = 8, message = "Placa deve ter entre 7 e 8 caracteres")
    //  PATTERN REGEX — WHITELIST DE CARACTERES
    ...
    //  ENUM PARA MARCA — NORMALIZAÇÃO E WHITELIST
    ...
    //  INTERVALO NUMÉRICO — VALIDAÇÃO DE TIPAGEM
